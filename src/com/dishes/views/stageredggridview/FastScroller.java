...
class FastScroller {
	...
	public FastScroller( Context context, StaggeredGridView listView ) {
	...
	private void resetThumbPos() {
		...
		// Bounds are always top right. Y coordinate get's translated during
		// draw
	...
	private void useThumbDrawable( Context context, Drawable drawable ) {
		...
		mThumbW = context.getResources().getDimensionPixelSize( R.dimen.fastscroll_thumb_width );
		mThumbH = context.getResources().getDimensionPixelSize( R.dimen.fastscroll_thumb_height );
		mChangedBounds = true;
	}
	...
	private void init( Context context ) {
		...
		mOverlayDrawable = res.getDrawable( R.drawable.empty_photo );// TODO:����ͼƬ
	...
	void onScroll( StaggeredGridView view, int firstVisibleItem, int visibleItemCount, int totalItemCount ) {
