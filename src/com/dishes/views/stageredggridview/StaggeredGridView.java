...
public class StaggeredGridView extends ViewGroup {
	...
	public StaggeredGridView(Context context, AttributeSet attrs, int defStyle) {
		...
		if (attrs != null) {
			...
			mColCount = a.getInteger(R.styleable.StaggeredGridView_numColumns,
					2);
			mDrawSelectorOnTop = a.getBoolean(
					R.styleable.StaggeredGridView_drawSelectorOnTop, false);
			a.recycle();
		} else {
			mColCount = 2;
	...
	protected int computeVerticalScrollOffset() {
		...
		if (firstPosition >= 0 && childCount > 0) {
			if (mSmoothScrollbarEnabled) {
				...
				int vertOffset = (int) (firstPosition + childCount
						* (index / (float) count));
				return vertOffset;
			}
		}
	...
	protected int computeVerticalScrollRange() {
		...
		// Log.d(TAG, "computeVerticalScrollRange " + result);
		return result;
	}
