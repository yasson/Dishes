...
public class StaggeredGridViewAdapter extends BaseAdapter {
	 ...
	 * @param sGridView
	 */
	public StaggeredGridViewAdapter( Context applicationContext, List<IngredientInfo> infos, StaggeredGridView sGridView ) {
	...
	public View getView( int position, View convertView, ViewGroup parent ) {
		...
		if( convertView == null ) {
			...
			convertView = layoutInflater.inflate( R.layout.adapter_ingredients_energy_lists, null );
